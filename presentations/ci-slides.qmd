...
TODO: re-show the architecture diagram again.
TODO: render the architecture diagram and show here.
...
TODO: insert image showing argo workflow viz for seal-tags
TODO: [optional], show `ogrinfo` output on resulting .gpkg
